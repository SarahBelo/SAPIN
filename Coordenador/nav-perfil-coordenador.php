    ...
    <main>
        <div id="fundo">
            <div>
                ...
                <br>
                <div id="buttons">
                    <button class="btn btn-primary btn-fundo" type="button" id="btnCancelar">Cancelar</button>
                    <button class="btn btn-primary btn-fundo" type="button" id="btnEditar">Editar</button>
                </div>
            </div>
        </div>
    </main>
...
async function carregarDadosCoordenador(id) {
    ...
    try {
        const request = await fetch('../Controller/Perfil/ListarIDCoordenador.php', config);
...
async function editarCoordenador(e) {
    ...
    try {
        const request = await fetch('../Controller/Perfil/EditarCoordenador.php', config);
...
$(document).ready(async function() {
    ...
    $('#btnCancelar').on('click', function() {
        window.location.href = `nav-perfil-coordenador.php?id=${id}`;
    });
});
